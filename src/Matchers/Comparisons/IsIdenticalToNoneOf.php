...
/**
 * An argument matcher that requires the actual value not to be identical to any of a set of expected values.
 */
class IsIdenticalToNoneOf implements MatcherContract
{
