...
use Mokkd\Matchers\Floats\IsBetween;
...
class IsBetweenTest extends TestCase
{
    ...
    /** Ensure floats between the bounds with small ranges match successfully. */
    ...
    /** Ensure floats between the bounds with large ranges match successfully. */
    ...
    /** Ensure floats between the bounds with large ranges and values close to the bound match successfully. */
    ...
    /** Ensure floats on the bounds match successfully. */
