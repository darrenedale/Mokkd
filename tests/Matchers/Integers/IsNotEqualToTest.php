...
use Mokkd\Matchers\Integers\IsNotEqualTo;
...
class IsNotEqualToTest extends TestCase
{
    ...
    /** Ensure ints equal to the constraint don't match. */
    ...
    /** Ensure ints that differ from the constraint value by a large quantity match successfully. */
    ...
    /** Ensure ints that differ from the constraint value by a small quantity match successfully. */
    ...
    /** Ensure a reasonable subset of non-ints match successfully. */
