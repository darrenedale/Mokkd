...
class IsZeroTest extends TestCase
{
    ...
    /** Ensure numerics equal to zero match successfully. */
    #[DataProvider("dataForTestMatches1")]
    public function testMatches1(int|float $testValue): void
    {
        self::assertTrue((new IsZero())->matches($testValue));
    }
    ...
    /** Ensure ints that differ from zero don't match. */
    #[DataProvider("dataForTestMatches2")]
    public function testMatches2(int $testValue): void
    {
        self::assertFalse((new IsZero())->matches($testValue));
    }
    ...
    {
        self::assertSame("(int|float) == 0", (new IsZero())->describe(self::nullSerialiser()));
    }
}
