...
use Mokkd\Matchers\Numerics\IsEqualTo;
...
class IsEqualToTest extends TestCase
{
    ...
    /** Ensure ints equal to an int constraint match successfully. */
    ...
    /** Ensure ints equal to a float constraint match successfully. */
    ...
    /** Ensure floats equal to an int constraint match successfully. */
    ...
    /** Ensure floats equal to a float constraint match successfully. */
    ...
    /** Ensure ints that differ from an int constraint value by a large quantity don't match. */
    ...
    /** Ensure floats that differ from an int constraint value by a large quantity don't match. */
    ...
    /** Ensure ints that differ from a float constraint value by a large quantity don't match. */
    ...
    /** Ensure floats that differ from a float constraint value by a large quantity don't match. */
    ...
    /** Ensure ints that differ from an int constraint value by a small quantity don't match. */
    ...
    /** Ensure floats that differ from an int constraint value by a small quantity don't match. */
    ...
    /** Ensure ints that differ from a float constraint value by a small quantity don't match. */
    ...
    /** Ensure floats that differ from a float constraint value by a small quantity don't match. */
