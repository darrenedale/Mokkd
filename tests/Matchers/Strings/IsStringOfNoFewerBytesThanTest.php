...
use LogicException;
use Mokkd\Matchers\Strings\IsStringOfNoFewerBytesThan;
...
class IsStringOfNoFewerBytesThanTest extends TestCase
{
    ...
    public function testConstructor1(int $length): void
    {
        ...
        new IsStringOfNoFewerBytesThan($length);
    }
    ...
    {
        self::assertSame($length, (new IsStringOfNoFewerBytesThan($length))->length());
    }
    ...
    {
        self::assertFalse((new IsStringOfNoFewerBytesThan($length))->matches($string));
    }
    ...
    {
        self::assertTrue((new IsStringOfNoFewerBytesThan($length))->matches($string));
    }
    ...
    {
        self::assertSame("(string[>={$length}])", (new IsStringOfNoFewerBytesThan($length))->describe(self::nullSerialiser()));
    }
}
