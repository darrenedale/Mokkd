...
class IsStringShorterThanTest extends TestCase
{
    ...
    public static function dataForTestMatches3(): iterable
    {
        ...
        yield "string-shorter-than-10-more-bytes-fewer-characters-u+00e9-utf16-ordered-le" => [10, "UTF-16", str_repeat("\xe9\x00", 6)];
        yield "string-shorter-than-10-more-bytes-fewer-characters-u+00e9-utf16-ordered-be" => [10, "UTF-16", str_repeat("\x00\xe9", 6)];
        ...
        yield "string-shorter-than-10-more-bytes-fewer-characters-u+10437-utf16-ordered-le" => [10, "UTF-16", str_repeat("\x01\xd8\x37\xdc", 3)];
        yield "string-shorter-than-10-more-bytes-fewer-characters-u+10437-utf16-ordered-be" => [10, "UTF-16", str_repeat("\xd8\x01\xdc\x37", 3)];
