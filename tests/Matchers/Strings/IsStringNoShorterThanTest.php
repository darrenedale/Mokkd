...
use LogicException;
use Mokkd\Matchers\Strings\IsNoShorterThan;
...
class IsStringNoShorterThanTest extends TestCase
{
    ...
    public function testConstructor1(int $length): void
    {
        ...
        new IsNoShorterThan($length);
    }

    /** Ensure encoding is UTF-8 by default. */
    public function testConstructor2(): void
    {
        self::assertSame("UTF-8", (new IsNoShorterThan(10))->encoding());
    }
    ...
    {
        self::assertSame($length, (new IsNoShorterThan($length))->length());
    }
    ...
    {
        self::assertSame($encoding, (new IsNoShorterThan(10, $encoding))->encoding());
    }
    ...
    {
        self::assertTrue((new IsNoShorterThan($length))->matches($string));
    }
    ...
    {
        self::assertFalse((new IsNoShorterThan($length))->matches($string));
    }
    ...
    public function testMatches3(int $length, string $encoding, string $encodedString): void
    {
        ...
        self::assertFalse((new IsNoShorterThan($length, $encoding))->matches($encodedString));
    }
    ...
    {
        self::assertSame($expected, (new IsNoShorterThan($length, $encoding))->matches($encodedString));
    }
    ...
    {
        self::assertSame("({$encoding}-string[>={$length}])", (new IsNoShorterThan($length, $encoding))->describe(self::nullSerialiser()));
    }

    /** Ensure the matcher describes itself with UTF-8 encoding by default. */
    public static function testDescribe2(): void
    {
        self::assertSame("(UTF-8-string[>=10])", (new IsNoShorterThan(10))->describe(self::nullSerialiser()));
    }
}
