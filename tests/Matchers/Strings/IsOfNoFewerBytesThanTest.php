...
use LogicException;
use Mokkd\Matchers\Strings\IsOfNoFewerBytesThan;
...
class IsOfNoFewerBytesThanTest extends TestCase
{
    ...
    public function testConstructor1(int $length): void
    {
        ...
        new IsOfNoFewerBytesThan($length);
    }
    ...
    {
        self::assertSame($length, (new IsOfNoFewerBytesThan($length))->length());
    }
    ...
    {
        self::assertFalse((new IsOfNoFewerBytesThan($length))->matches($string));
    }
    ...
    {
        self::assertTrue((new IsOfNoFewerBytesThan($length))->matches($string));
    }
    ...
    {
        self::assertSame("(string[>={$length}])", (new IsOfNoFewerBytesThan($length))->describe(self::nullSerialiser()));
    }
}
